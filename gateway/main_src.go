...
func (m *MainSrc) Write() error {
	...
	for _, schema := range m.schemas {
		...
		res = append(res, fmt.Sprintf(`	r.GET("/%ss", toGin(%sController.List))`, schema.LowerSnakeSchemaName(), schema.LowerSchemaName()))
		res = append(res, fmt.Sprintf(`	r.GET("/%ss/:id", toGin(%sController.Get))`, schema.LowerSnakeSchemaName(), schema.LowerSchemaName()))
		res = append(res, fmt.Sprintf(`	r.POST("/%ss", toGin(%sController.Post))`, schema.LowerSnakeSchemaName(), schema.LowerSchemaName()))
		res = append(res, fmt.Sprintf(`	r.PUT("/%ss/:id", toGin(%sController.Put))`, schema.LowerSnakeSchemaName(), schema.LowerSchemaName()))
		res = append(res, fmt.Sprintf(`	r.DELETE("/%ss/:id", toGin(%sController.Delete))`, schema.LowerSnakeSchemaName(), schema.LowerSchemaName()))
	}
	res = append(res, ``)
